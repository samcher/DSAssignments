The Column names of the final data set are as shown below:

 [1] "Subject_ID"                  "Activity_TYPE"               "tBodyAcc-mean()-X"           "tBodyAcc-mean()-Y"          
...
The data is grouped by the Subject_ID and the Activity_TYPE and the mean is calculated for the columns.
